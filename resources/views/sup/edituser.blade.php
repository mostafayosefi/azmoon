          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> <a href="{{env('APP_URL')}}/superadmin/viewsusers">مشاهده کاربران</a></li>
                <li class="breadcrumb-item active" aria-current="page">مدیریت اطلاعات کاربر</li>
              </ol>
            </nav>
          </div>
...
<div class="preview-item-content d-flex flex-grow">
<div class="flex-grow"><h6 class="preview-subject"><span class="float-right">  مبلغ شارژ حساب </span>
<span class="float-left small"> <span class="text-muted pl-3">{{$chargeac}} ريال  </span> </span> </h6> 
</div>
</div>
</div>
...
<div  @if($admin->user_active == '1')  class="bg-success" @else  class="bg-warning" @endif   style="padding:20px; 50px;">
 ...
 <a href="rej/{{$admin->id}}"   >
	 <button type="button" class="btn btn-warning btn-sm">  غیرفعال کردن حساب کاربر 
 ...
 <a href="acc/{{$admin->id}}"  >
 		 <button type="button" class="btn btn-success btn-sm">  فعال کردن حساب کاربر 
