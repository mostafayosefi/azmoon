...
var myResultt =  parseFloat(document.getElementById('box1').value) * myBox2  ; 
...
@if(($admin->form_linkname=='hotelscom')||($admin->form_linkname=='airbnb'))  
 ...
 <input type="text" class="form-control"  name="name{{$admin->list_id}}" @if($admin->list_disc=='1')      placeholder="{{$admin->list_pan}}" @else      placeholder="{{$admin->list_pan}}"   @endif     @if($admin->list_price=='1')   id="box1" oninput="calculate();"  @endif    >                
 </div>
...
@else
 ...
 <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
  @if ($errors->has('name')) <label class="error mt-2 text-danger"  >{{$admin->list_name}}</label> @else 
 <label >{{$admin->list_name}}</label> @endif
 <input type="text" class="form-control"  name="name{{$admin->list_id}}" @if($admin->list_price=='1')   value="{{$form->form_price}}"   placeholder="{{$form->form_price}} ريال" disabled="" @elseif($admin->list_disc=='1')   value="{{ old('name') }}"   placeholder="{{$admin->list_pan}}"   oninput="calculate();" @else   value="{{ old('name') }}"   placeholder="{{$admin->list_pan}}"   @endif       >                
 </div>
...
<div class="input-group date" id="timepicker-example" data-target-input="nearest"> <label >{{$admin->list_name}}</label> 
 ...
 <div class="input-group date" id="timepicker-example1" data-target-input="nearest"> <label >{{$admin->list_name}}</label> 
                        <div class="input-group" data-target="#timepicker-example1" data-toggle="datetimepicker">
                          <input type="time" class="form-control datetimepicker-input"
                            data-target="#timepicker-example1"  name="name{{$admin->list_id}}"  />
...
<script> 
    function calculate() { 
        ...
        var result7 = document.getElementById('resul7');  
...
var myResult7 = myBox3  ;   document.getElementById('result7').value = myResult7;
...
<input type="hidden" name="disccodereq" id="result7" oninput="calculate();" value="">


<input type="hidden" name="disc" id="box5" oninput="calculate();" value="{{$form->form_price}}">
...
@if((($admin->list_typ=='1')&&($admin->list_price=='1'))&&(($admin->form_linkname=='hotelscom')||($admin->form_linkname=='airbnb')))  
   
    
 
<input  id="box2" type="hidden" oninput="calculate();"   value="{{$currency->cur_gh}}"  >  
		    	

<div class="form-group {{ $errors->has('aa') ? 'has-error' : '' }}">   
 
 <label class="control-label">قیمت دلار بر اساس ریال  </label>  
<input type="text"   name="aa" disabled=""   class="form-control" value="{{$currency->cur_gh}}"  > 
</div> 
