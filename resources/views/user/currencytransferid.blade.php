...
<label class="control-label">هزینه  : </label> 
  <span class="label label-success" style="direction: ltr;">{{$admin->ctrf_pay}} {{$admin->cur_nem}}</span>
</div>  
...
<label class="control-label">کارمزد ثابت  : </label> 
  <span class="label label-success"  style="direction: ltr;">0 {{$admin->cur_nem}}</span>
</div>  
