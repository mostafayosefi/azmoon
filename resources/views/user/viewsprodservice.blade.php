...
@section('title')
<title>مشاهده سفارشات سرویس ها </title>
@stop
...
@section('superadmin')
	 ...
	 <div class="main-content" >
			<h1 class="page-title" >مشاهده سفارشات سرویس ها</h1>
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="{{env('APP_URL')}}/user/panel"><i class="fa fa-home"></i>پنل مدیریت</a></li> 
				<li><a href="{{env('APP_URL')}}/user/viewsprodservice">مشاهده سفارشات سرویس ها</a></li> 
...
<td><a href="viewsprodservice/{{$admin->prcrtr_id}}" > <span class="label label-success">پرداخت شده</span></a></td>
@elseif($admin->prcrtr_payment != '1')
<td><a href="viewsprodservice/{{$admin->prcrtr_id}}"   ><span class="label label-warning">منتظر پرداخت</span></a></td>
@endif
