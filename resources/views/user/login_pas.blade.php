    ...
    <div class="form-body" class="container-fluid">
        ...
        <div class="row">
         ...
         <div class="page-links">
            <a href="{{env('APP_URL')}}/user/sign-in" class="active">ورود</a>
            <a href="{{env('APP_URL')}}/user/registeruser">عضویت</a>
            <a href="{{env('APP_URL')}}/user/forgetpas"> فراموشی رمزعبور</a>
           </div>

 <form method="POST" action="{{env('APP_URL')}}/user/login_pas" autocomplete="off"> 
    ...
    <div class="alert alert-danger">
      ...
      <div class="alert alert-success">
				<strong>باموفقیت انجام شد!</strong>
	...
	@if(count($errors))
        ...
        <div class="form-group">
            ...
            <div class="input-group {{ $errors->has('userpassword') ? 'has-error' : '' }}" >
                <div class="input-group-addon"><i class="fa fa-mail"></i></div>
                <input class="form-control ltr"  type="password"     id="userpassword" name="userpassword"  value=""  />
            </div>
        </div>
