...
@section('superadmin')
		...
		<div class="main-content" >
			<h1 class="page-title" >خرید از سایتهای خارجی</h1>
			...
			<div class="col-lg-12 animatedParent animateOnce z-index-50">
				<div class="panel panel-default animated fadeInUp">
					<div class="panel-heading clearfix"> 
						<h3 class="panel-title">خرید از سایتهای خارجی</h3> 
 ...
 @elseif ($admins)   
		@foreach($admins as $admin)	
 			...
 			<!--
 							<div class="col-lg-6 animatedParent animateOnce z-index-50"><hr>
	<div class="col-lg-6"><p><strong>vvvvvvv</strong></p></div> 
	<div class="col-lg-6"><img   src="{{env('APP_URL')}}/public/images/vvvvvv"  width="128"  height="128"  ></div>
