						...
						<div class="col-md-12 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">فاکتورها</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right"> 
<li><a href="{{env('APP_URL')}}/user/finicals"><i class="icon-list"></i>مشاهده فاکتورها</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$finicalscount}}</h1>
											<small>تعداد کل فاکتورها</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$finicalsactivecount}}</h1>
											<small>فاکتورهای پرداخت شده</small>
										</div>
									</div>
								</div> 
							</div>
 ...
 <div class="col-lg-3">
					<div class="row">
						<div class="col-md-12 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">پرداخت های ارزی</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right"> 
<li><a href="{{env('APP_URL')}}/user/viewsprodbuy"><i class="icon-list"></i>مشاهده پرداخت های ارزی</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$curfcount}}</h1>
											<small>تعداد درخواستهای من</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$curfpaycount}}</h1>
											<small>درخواستهای پرداخت شده</small>
										</div>
									</div>
								</div> 
							</div>
 ...
 <div class="col-lg-3">
					<div class="row">
						<div class="col-md-12 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">سرویسها</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right"> 
<li><a href="{{env('APP_URL')}}/user/viewsprodservice"><i class="icon-list"></i>مشاهده سرویسها</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$servicecounts}}</h1>
											<small>تعداد درخواستهای من</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$servicepaycounts}}</h1>
											<small>درخواستهای پرداخت شده</small>
										</div>
									</div>
								</div> 
 ...
 -->
		...
		<div class="row">
						<div class="col-md-12 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">قیمت ارزهای پایه</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right"> 
<li><a href="#"><i class="icon-list"></i>مشاهده</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
...
@foreach($currencys as $currency)
										<div class="col-xs-2 text-center stack-order"> 
 <h1 class="no-margins"><span class="label label-success">{{$currency->cur_nem}}</span></h1>
 <small>{{$currency->cur_gh}} ريال</small>
										</div>
@endforeach
 ...
 <div class="row">
			<div class="col-lg-12 animatedParent animateOnce z-index-50">
				<div class="panel panel-default animated fadeInUp">
					<div class="panel-heading clearfix"> 
						<h3 class="panel-title">{{$cat->catf_name}}</h3> 
...
@if($cat->catf_id==$form->form_cat)
 <a href="onlineshops/{{$form->form_rnd}}">
 ...
 <div class="panel panel-default animated fadeInUp">
					...
					<div class="panel-body">  
						<p>{{$form->form_des}}</p>
 <div class="thumb">
 <img class="img-responsive" src="{{env('APP_URL')}}/public/images/{{$form->form_img}}"  width="128"  height="128"  alt="Articales Post">
 </div> 
					</div> 
				</div>
			</div>
 ...
 @endif
  @if($cat->catf_id!=$form->form_cat) <?php $i=0; ?>  @else  <?php  $i++; ?> @endif				
 @endforeach	
...
@endif
 ...
 <div class="row">
			<div class="col-lg-12 animatedParent animateOnce z-index-50">
				<div class="panel panel-default animated fadeInUp">
					<div class="panel-heading clearfix"> 
						<h3 class="panel-title">سایر خدمات</h3> 
 ...
 @if   (empty ($forms))             
 @elseif ($forms)   
		@foreach($forms as $admin)	

@if($admin->form_cat=='0')	
					
					
					
											   <a href="onlineshops/{{$admin->form_rnd}}">
							<div class="col-lg-6 animatedParent animateOnce z-index-45">
				<div class="panel panel-default animated fadeInUp">
					<div class="panel-heading clearfix"> 
						<h3 class="panel-title">{{$admin->form_name}}</h3> 
					</div> 
					...
					<div class="panel-body"> 
						...
						<p>{{$admin->form_des}}</p>
							<div class="thumb">
													<img class="img-responsive" src="{{env('APP_URL')}}/public/images/{{$admin->form_img}}"  width="128"  height="128"  alt="Articales Post">
