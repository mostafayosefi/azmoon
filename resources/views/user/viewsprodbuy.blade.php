...
@section('title')
<title>مشاهده سفارشات حواله های ارزی </title>
@stop
...
@section('superadmin')
	 ...
	 <div class="main-content" >
			<h1 class="page-title" >مشاهده سفارشات حواله های ارزی</h1>
			<!-- Breadcrumb -->
...
<td><a href="viewsprodbuy/{{$admin->prcrtr_id}}" > <span class="label label-success">پرداخت شده</span></a></td>
@elseif($admin->prcrtr_payment != '1')
<td><a href="viewsprodbuy/{{$admin->prcrtr_id}}"   ><span class="label label-warning">منتظر پرداخت</span></a></td>
@endif
