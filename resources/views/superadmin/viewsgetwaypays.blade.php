...
@section('title')
<title>مدیریت درگاههای پرداخت </title>
@stop
...
@section('superadmin')
	 ...
	 <div class="main-content" >
			<h1 class="page-title" >مدیریت درگاههای پرداخت</h1>
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="{{env('APP_URL')}}/superadmin/panel"><i class="fa fa-home"></i>پنل کاربر</a></li> 
				<li><a href="{{env('APP_URL')}}/superadmin/viewsgetwaypays">مدیریت درگاههای پرداخت</a></li> 
				...
				<div class="col-lg-12 animatedParent animateOnce z-index-50">
					<div class="panel panel-default animated fadeInUp">
						<div class="panel-heading clearfix">
							<h3 class="panel-title" >لیست درگاههای پرداخت</h3>
...
@foreach ($admins as $admin)
										...
										<tr class="gradeX">
										 <td>{{$i++}} </td>
                        <td>{{$admin->getway_name}} </td>   
                        <td>{{jDate::forge($admin->getway_createdatdate)->format('Y/m/d ساعت H:i a')}}</td>
 
@if($admin->getway_active == '1') 
<td><a href="viewsgetwaypays/getwaypay/{{$admin->id}}"   ><span class="label label-success">فعال</span></a></td>
@elseif($admin->getway_active == '0') 
<td><a href="viewsgetwaypays/getwaypay/{{$admin->id}}"   ><span  class="label label-warning">غیرفعال</span></a></td>
