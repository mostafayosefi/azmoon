...
@section('superadmin')
 ...
 <h3>{{$admin->ctrf_name}}</h3><div class="line-dashed"></div> 
 ...
 <p>هزینه سرویس:<span class="label label-success">{{$admin->ctrf_pay}}{{$admin->cur_nem}}</span></p> <div class="line-dashed"></div>
 ...
 <p>تاریخ ثبت سرویس:{{jDate::forge($admin->ctrf_createdatdate)->format('l d F Y ساعت H:i a')}}</p>
<div class="line-dashed"></div>
