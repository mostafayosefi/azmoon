...
@section('superadmin')
	 ...
	 <div class="main-content" >
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li><a href="{{env('APP_URL')}}/superadmin/viewspages">مشاهده خدمات</a></li> 
...
<td><a href="viewspages/editpage/{{$admin->id}}" > <span class="label label-success">فعال</span></a></td>
@elseif($admin->page_active != '1')
<td><a href="viewspages/editpage/{{$admin->id}}"   ><span class="label label-warning">غیرفعال</span></a></td>
@endif

<td><a href="viewspages/delet/{{$admin->id}}"   ><span class="label label-danger">حذف</span></a></td>
