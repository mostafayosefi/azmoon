...
@section('superadmin')
		...
		<div class="main-content" >
			<h1 class="page-title" >ثبت خبر</h1>
...
<div class="form-group {{ $errors->has('tit') ? 'has-error' : '' }}">   
 @if ($errors->has('tit'))   
 <label class="col-sm-3 control-label" for="inputError">عنوان خبر</label> @else
 <label class="col-sm-3 control-label">عنوان خبر</label> @endif
<div class="col-sm-9"> 
<input type="text" name="tit"  placeholder="عنوان خبر" class="form-control"   value="{{ old('tit') }}"   > 
</div> 
</div> 
<div class="line-dashed"></div>
