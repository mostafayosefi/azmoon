...
@section('superadmin')
	 ...
	 <div class="main-content" >
			<h1 class="page-title" >مشاهده کارنسی ها</h1>
			<!-- Breadcrumb -->
				...
				<div class="col-lg-12 animatedParent animateOnce z-index-50">
					<div class="panel panel-default animated fadeInUp">
						<div class="panel-heading clearfix">
							<h3 class="panel-title" >لیست کارنسی ها</h3>
...
@foreach ($admins as $admin)
										...
										<tr class="gradeX">
										 <td>{{$i++}} </td>
 <td>{{$admin->cur_name}} <span class="label label-success">{{$admin->cur_nem}}</span> </td>  
                        <td>{{$admin->cur_gh}} ريال</td>  
@if($admin->cur_active == '1')                       
<td><a href="viewscurrency/{{$admin->id}}" > <span class="label label-success">فعال</span></a></td>
@elseif($admin->cur_active != '1')
<td><a href="viewscurrency/{{$admin->id}}"   ><span class="label label-warning">غیرفعال</span></a></td>
@endif
