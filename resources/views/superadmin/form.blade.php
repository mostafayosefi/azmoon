...
<div class="page-container">
	...
	<div class="page-sidebar">
		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub active"><a href="form-basic.html"><i class="icon-doc-text"></i><span class="title">Forms</span></a>
				<ul class="nav">
					<li><a href="form-basic.html"><span class="title">Basic Form</span></a></li>
					<li class="active"><a href="form-advanced.html"><span class="title">Advanced Plugins</span></a></li>
				...
				<div class="col-lg-12 animatedParent animateOnce z-index-48">
					<div class="panel panel-default animated fadeInUp">
						<div class="panel-heading clearfix">
							<h3 class="panel-title">Selectbox Replacement</h3>
