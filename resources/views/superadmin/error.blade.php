...
@section('superadmin')
 ...
 <div class="row"> 
				<div class="col-md-12 animatedParent animateOnce z-index-45"> 
					<div class="panel panel-danger animated fadeInUp">
						<div class="panel-heading clearfix"> 
							<div class="panel-title"><i class="icon fa fa-check"></i>اخطار!</div> 
				
				
						</div> 
						<!-- panel body -->  
							<p>   {{ Session::get('statust')}}</p> 
							    
                    <p>  برای بازگشت کلیک نمایید     <a href="{{ url('/superadmin/') }}/{{ Session::get('sessurl')}}">بازگشت</a></p> 
