...
@section('superadmin')
		...
		<div class="main-content" >
			<h1 class="page-title" >ثبت حواله ارزی</h1>
...
<div class="col-sm-9"> 
<input type="text" name="name"  placeholder="نام حواله ارزی" class="form-control"   value="{{ old('name') }}"   > 
</div> 
</div> 
<div class="line-dashed"></div>
...
function fetch_select(val){var val = document.getElementById("cata").value;$.ajax({type: 'get',url: '{{env("APP_URL")}}/superadmin/fechcur/'+val,data: {get_option:val},success: function (response) {document.getElementById("catam").innerHTML=response;}});}
</script>
...
<div class="form-group {{ $errors->has('fixfee') ? 'has-error' : '' }}">   
 ...
 <label class="col-sm-3 control-label" for="inputError">کارمزد ثابت بر حسب <p id="catam"></p></label> @else
 <label class="col-sm-3 control-label">کارمزد ثابت بر حسب <p id="catam"></p></label> @endif
<div class="col-sm-9"> 
                     ...
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
							...
							<div class="form-group"> 
								<div class="col-sm-offset-2 col-sm-10"> 
								       <button class="btn btn-success btn-block btn-flat">ثبت حواله ارزی</button>
								</div> 
							</div>
						</form>
					</div>
