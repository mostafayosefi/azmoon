...
@section('title')
<title>مشاهده حواله های ارزی </title>
@stop
...
@section('superadmin')
	 ...
	 <div class="main-content" >
			<h1 class="page-title" >مشاهده حواله های ارزی</h1>
			<!-- Breadcrumb -->
				...
				<div class="col-lg-12 animatedParent animateOnce z-index-50">
					<div class="panel panel-default animated fadeInUp">
						<div class="panel-heading clearfix">
							<h3 class="panel-title" >لیست حواله های ارزی</h3>
...
<td><a href="viewscurrencytransfer/{{$admin->ctrf_id}}" > <span class="label label-success">فعال</span></a></td>
@elseif($admin->ctrf_active != '1')
<td><a href="viewscurrencytransfer/{{$admin->ctrf_id}}"   ><span class="label label-warning">غیرفعال</span></a></td>
@endif

 <td><a href="viewscurrencytransfer/delet/{{$admin->ctrf_id}}"  > <span class="label label-danger">حذف</span></a></td>
