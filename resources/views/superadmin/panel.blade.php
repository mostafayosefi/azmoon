...
<li><a href="{{env('APP_URL')}}/superadmin/adduser"><i class=" glyphicon-plus"></i>ثبت کاربر</a></li>
<li><a href="{{env('APP_URL')}}/superadmin/viewsusers"><i class="icon-list"></i>مشاهده کاربران</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											...
											<small>تعداد کل کاربران</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$useractives}}</h1>
						...
						<div class="col-md-6 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">حواله های ارزی</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right">
<li><a href="{{env('APP_URL')}}/superadmin/addcurrencytransfer"><i class=" glyphicon-plus"></i>ثبت حواله ارزی</a></li>
<li><a href="{{env('APP_URL')}}/superadmin/viewscurrencytransfer"><i class="icon-list"></i>مشاهده حواله های ارزی</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$havs}}</h1>
											<small>تعداد حواله های ارزی</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$havsactive}}</h1>
											<small>حواله های ارزی فعال</small>
										</div>
									</div>
								</div> 
							</div>
						...
						<div class="col-md-6 animatedParent animateOnce z-index-50">
							<div class="panel minimal panel-default animated fadeInUp go">
								<div class="panel-heading clearfix"> 
									<div class="panel-title">سرویس ها</div> 
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right">
<li><a href="{{env('APP_URL')}}/superadmin/addservice"><i class=" glyphicon-plus"></i>ثبت سرویس</a></li>
<li><a href="{{env('APP_URL')}}/superadmin/viewsservice"><i class="icon-list"></i>مشاهده سرویس ها</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
								...
								<div class="panel-body">
									<div class="row col-with-divider">
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$servess}}</h1>
											<small>تعداد سرویس ها</small>
										</div>
										<div class="col-xs-6 text-center stack-order"> 
											<h1 class="no-margins">{{$serviceactive}}</h1>
											<small>سرویس های فعال</small>
										</div>
									</div>
								</div> 
							</div>
								...
								<div class="panel-heading clearfix"> 
									...
									<ul class="panel-tool-options"> 
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false"><i class="icon-cog"></i></a>
											<ul class="dropdown-menu dropdown-menu-right"> 
<li><a href="{{env('APP_URL')}}/superadmin/finicals"><i class="icon-list"></i>مشاهده فاکتورها</a></li>  
											</ul>
										 </li>
									</ul> 
								</div> 
