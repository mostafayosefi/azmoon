...
<table border="0" cellpadding="0" cellspacing="0" width="700">
 ...
 <tbody><tr> <td width="100%" style="direction:rtl;border-collapse:collapse;color:#525252;padding:10px;background-color:rgb(255,255,255);border-color:rgb(221,221,221);border-width:1px;border-radius:5px;border-style:solid;font-size:8pt;padding:15px 40px!important" align="justify" dir="rtl" valign="top">
...
{{$titmes}} 
 ...
 <br>
 {{$usernamee}} عزیز {{$titmes}} 
 <br>
 
 نام کاربری : {{$user->user_email}} 
<br>
{{$mestt}} : {{$mesnot}} 
<br>
تشکر
...
<br>
https://servicepay.azmoonpte.com/
 <br><br> 
 ...
 <table width="100%" valign="top" border="0" cellpadding="0" cellspacing="0" dir="rtl"> <tbody><tr>
...
توجه : این ایمیل به صورت خودکار فرستاده شده است ، بنابراین به آن جواب ندهید و منتظر ایمیل ما باشید.
 ...
 <a href="{{env('APP_URL')}}/" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">صفحه نخست</a>
&nbsp; |&nbsp;&nbsp;
<a href="{{env('APP_URL')}}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">درباره ما</a>
&nbsp; |&nbsp;&nbsp;
<a href="{{env('APP_URL')}}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">ارتباط با ما</a>
&nbsp; |&nbsp; 
<a href="#" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">ما در اینستاگرام</a>
 </center>
 </td> 
</tr> 
</tbody>
