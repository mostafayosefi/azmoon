...
@section('superadmin')
 ...
 <h3>{{$admin->new_tit}}</h3><div class="line-dashed"></div>  
								<p>  {{$admin->new_kh}}</p> <div class="line-dashed"></div>
								<p>  <?php echo $admin->new_des; ?></p> <div class="line-dashed"></div>
 <p>عکس خبر:<span class="label"><img  src="{{env('APP_URL')}}/public/images/{{$admin->new_img}}" class="img-circle" width="32"  height="32"   alt="" title=""></span></p> <div class="line-dashed"></div> 
 <p>تاریخ ثبت :{{jDate::forge($admin->new_createdatdate)->format('l d F Y ساعت H:i a')}}</p>
<div class="line-dashed"></div>
...
<div class="form-group {{ $errors->has('tit') ? 'has-error' : '' }}">   
 @if ($errors->has('tit'))   
 <label class="col-sm-3 control-label" for="inputError">تیتر خبر</label> @else
 <label class="col-sm-3 control-label">تیتر خبر</label> @endif
<div class="col-sm-9"> 
<input type="text" name="tit"  placeholder="تیتر خبر" class="form-control" @if ($admin->new_tit) value="{{$admin->new_tit}}"@else value="{{ old('tit') }}" @endif > 
</div> 
</div>
...
<div class="form-group {{ $errors->has('des') ? 'has-error' : '' }}">               
 @if ($errors->has('des'))                 
<label class="col-sm-3 control-label" for="inputError">خلاصه خبر</label>
@else 
 <label class="col-sm-3 control-label">خلاصه خبر </label> 
@endif
<div class="col-sm-9"> 
<textarea  class="form-control"  id="kh" name="kh"    rows="5">@if($admin->new_kh){{$admin->new_kh}}@else{{old('kh')}}@endif</textarea>   </div>
 </div>  
...
<div class="form-group {{ $errors->has('des') ? 'has-error' : '' }}">               
 @if ($errors->has('des'))                 
<label class="col-sm-3 control-label" for="inputError">متن خبر</label>
@else 
 <label class="col-sm-3 control-label">متن خبر </label> 
@endif
<div class="col-sm-9"> 
<textarea  class="form-control ckeditor" id="des"  name="des"    rows="5">@if($admin->new_des){{$admin->new_des}}@else{{old('des')}}@endif</textarea>   </div>
 </div>  
...
@if ($errors->has('file'))   
 ...
 <label class="col-sm-3 control-label">آپلود عکس <span class="label"><img  src="{{env('APP_URL')}}/public/images/{{$admin->new_img}}" class="img-circle" width="32"  height="32"   alt="" title=""></span></label>
							 	@endif
 <div class="col-sm-9"> 
