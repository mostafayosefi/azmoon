...
@section('title')
<title>ثبت شبکه های اجتماعی </title>
@stop
...
@section('superadmin')
		...
		<div class="main-content" >
			<h1 class="page-title" >ثبت شبکه های اجتماعی</h1>
...
<div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">   
 @if ($errors->has('link'))   
 <label class="col-sm-3 control-label" for="inputError">لینک شبکه اجتماعی</label> @else
 <label class="col-sm-3 control-label">لینک شبکه اجتماعی</label> @endif
<div class="col-sm-9"> 
<input type="text" name="link"  placeholder="لینک شبکه اجتماعی" class="form-control"   value="{{ old('link') }}"   > 
</div> 
</div> 
<div class="line-dashed"></div>
 ...
 <div class="form-group {{ $errors->has('file') ? 'has-error' : '' }}">
							 @if ($errors->has('file'))   
							 	<label class="col-sm-3 control-label"  for="inputError">آپلود آیکن </label> 
							 	@else 
