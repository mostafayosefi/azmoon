...
@section('superadmin')
	 ...
	 <div class="main-content" >
			...
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="{{env('APP_URL')}}/superadmin/panel"><i class="fa fa-home"></i>پنل کاربر</a></li> 
				<li><a href="{{env('APP_URL')}}/superadmin/viewsuserticketssup">مشاهده تیکتهای کاربران</a></li> 
				...
				<div class="col-lg-12 animatedParent animateOnce z-index-50">
					<div class="panel panel-default animated fadeInUp">
						<div class="panel-heading clearfix">
							<h3 class="panel-title" >لیست تیکتهای کاربران</h3>
...
<td><a href="viewsuserticketssup/ticket/{{$admin->id}}" > <span class="label label-success">پاسخ داده شده</span></a></td>
@elseif($admin->tik_active == '1') 
<td><a href="viewsuserticketssup/ticket/{{$admin->id}}"   ><span class="label label-warning">منتظر پاسخ</span></a></td>
@elseif($admin->tik_active == '0') 
<td><a href="viewsuserticketssup/ticket/{{$admin->id}}"   ><span class="badge bg-blue">بسته شده</span></a></td>

@endif

<td><a href="viewsuserticketssup/delet/{{$admin->id}}"   ><span class="label label-danger">حذف</span></a></td>
